...
print(f'Length of each parent1: {len(p1)}')
print(f'Length of each parent2: {len(p2)}')
print(f'Length of each child1: {len(offspring[0])}')
print(f'Length of each child2: {len(offspring[1])}')
